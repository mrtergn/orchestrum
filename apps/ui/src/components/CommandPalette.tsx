...
export function CommandPalette() {
  ...
  const actions = useMemo<ActionItem[]>(
    () => [
      ...
      { id: "nav-agents", label: "Go to Agents", section: "Navigation", run: () => router.push("/agents") },
      { id: "nav-org", label: "Go to Org Chart", section: "Navigation", run: () => router.push("/org") },
      { id: "nav-tasks", label: "Go to Tasks", section: "Navigation", run: () => router.push("/tasks") },
